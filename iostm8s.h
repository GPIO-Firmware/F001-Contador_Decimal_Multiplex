...
///UART2 section//included by WWM/////////////////
volatile char UART2_SR			@0x5240;						//
volatile char UART2_DR			@0x5241;						//
volatile char UART2_BRR2		@0x5242;						//
volatile char UART2_BRR1		@0x5243;						//
volatile char UART2_CR1			@0x5244;						//
volatile char UART2_CR2			@0x5245;						//
volatile char UART2_CR3			@0x5246;						//
volatile char UART2_CR4			@0x5247;						//
volatile char UART2_CR6			@0x5249;						//
volatile char UART2_GTR			@0x524A;						//
volatile char UART2_PSCR		@0x524B;						//
//////////////////////////////////////////////////

/*	USART3 section
 */
volatile char USART3_SR     @0x5240;	/* Status register */
volatile char USART3_DR     @0x5241;	/* Data register */
volatile char USART3_BRR1   @0x5242;	/* Baud Rate reg 1 */
volatile char USART3_BRR2   @0x5243;	/* Baud Rate reg 2 */
volatile char USART3_CR1    @0x5244;	/* Control reg 1 */
volatile char USART3_CR2    @0x5245;	/* Control reg 2 */
volatile char USART3_CR3    @0x5246;	/* Control reg 3 */
volatile char USART3_CR4    @0x5247;	/* Control reg 4 */
volatile char USART3_CR6    @0x5249;	/* Control reg 6 */
...
/*	CAN section
 */
volatile char CAN_MCR       @0x5420;	/* can master control reg */
